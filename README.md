...
```js
import { diagnostics } from '@liquid-bricks/lib-diagnostics';
import { createConsoleMetrics } from '@liquid-bricks/lib-diagnostics/metrics/console';
// or: import { createNatsMetrics } from '@liquid-bricks/lib-diagnostics/metrics/nats';
